...
def analisar_dataframe_gemini(df: str, api_key: str, prompt: str, municipio: str, model: str = 'gemini-1.5-flash', temperature: float = 0.7, stop_sequence: str = '') -> str:
    """
        ...
        if municipio:
            ...
            with st.spinner('Processando consulta...'):
                ...
                if not tabela_formatada.empty:
                    ...
                    - Não cite datas.
                    - Qualquer situação só é grave com mais de 1 ano de atraso.
                    - Destaque o texto com verde, laranja e vermelho onde aplicável.
                    - Ao final, confira os prazos novamente.
